---
title: "Onderzoeksvraag en onderzoeksontwerp"
---
...
![Verschillende soorten correlaties.](img/H2_correlatie.png){#fig-correlation .illustration}
...
::: {.callout-tip icon="false" collapse="true" title="Voorbeeldonderzoek verband tussen cafeïne-inname en depressie"}
![](img/H2_cafeine_depression.png){.illustration}
...
## Directe en indirecte kenmerken
...
### Moderator, Mediator en Confounder
...
![Overzicht van steekproeftrekking en tijdsvolgorde in onderzoeksontwerpen gebruikt in epidemiologische voedingsstudies (aangepaste figuur van Margetts & Nelson [-@margetts1997]).](img/H2_studydesigns.png){#Fig- .illustration}
...
![Randomisatie.](img/H2_Simple-randomization.png){#Fig-random .illustration width="400"}
...
![Matchen.](img/H2_Matched-pairs.png){#Fig-matchen .illustration width="400"}
...
#### Verstorende factoren bij het experiment
...
-   **Nocebo-effect**: Dit treedt op wanneer deelnemers negatieve bijwerkingen of verslechtering ervaart omdat ze verwachten dat een behandeling nadelige effecten zal hebben, zelfs als de interventie geen actief werkzame stof bevat. Dit effect kan leiden tot klachten zoals hoofdpijn, misselijkheid of angst, puur door de verwachting van schadelijke effecten. In experimenteel onderzoek kan het nocebo-effect de resultaten verstoren, aangezien de uitkomst niet te wijten is aan de behandeling zelf, maar aan de negatieve verwachtingen van de deelnemer.
